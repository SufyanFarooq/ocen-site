...
export default function FAQPage() {
  ...
  const faqs = [
    {
      question: "What is YST - YIWU SALAH Trading and what services do you provide?",
      answer: "YST - YIWU SALAH Trading is a comprehensive sourcing company that connects China businesses with verified manufacturers and suppliers worldwide. We provide end-to-end sourcing solutions including Yiwu market guidance, airport pickup, order tracking, quality control, container loading, customs clearance, and shipping services."
    },
    {
