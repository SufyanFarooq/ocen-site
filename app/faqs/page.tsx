  ...
  const faqs = [
    {
      ...
      answer: "YST - YIWU SALAH Traders is a comprehensive sourcing company that connects China businesses with verified manufacturers and suppliers worldwide. We provide end-to-end sourcing solutions including Yiwu market guidance, airport pickup, order tracking, quality control, container loading, customs clearance, and shipping services."
    },
    {
