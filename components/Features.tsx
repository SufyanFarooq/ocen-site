...
const Features = () => {
  ...
  const features = [
    ...
    },
    {
      icon: Users,
      title: 'China Company',
      description: 'Payment methods, Communication, and accountability are the same as with any local company in China.',
      ...
      {currentSlide === features.length - 1 && (
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              You have two options when it comes to buying from China as an China business
            </motion.h3>
